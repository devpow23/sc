#!/bin/bash
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/devpow23/sc/main/files/msg) 
...
start(){
[[ -e /bin/ejecutar/checkuser.py ]] || wget -q -O /bin/ejecutar/checkuser.py https://raw.githubusercontent.com/devpow23/sc/main/files/checkuser.py && chmod +x /bin/ejecutar/checkuser.py
    ...
    if wget -O /usr/bin/check https://raw.githubusercontent.com/devpow23/sc/main/files/check.sh &>/dev/null; then
...
_onli() {
   ...
   print_center -ama 'Instalandon check'
    if wget -O /usr/bin/onlineapp https://raw.githubusercontent.com/devpow23/sc/main/files/onlineapp.sh &>/dev/null; then
